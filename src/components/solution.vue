...
const features = [
  ...
  { title: 'Unlimited Emails',            mrp: '3000', img: `src/assets/solution/letter.png`,       tag: 'Engage',
    desc:'Broadcasts, drips & automations—no caps. Real-time analytics included.' },
  { title: 'Unlimited WhatsApp Messages', mrp: '2500', img: `src/assets/solution/whatsapp.png`,     tag: 'Engage',
    desc:'WhatsApp broadcasts, reminders & journeys that drive quick replies.' },
  { title: 'Unlimited Automations',       mrp: '5000', img: `src/assets/solution/automation.png`,   tag: 'Automate',
    desc:'Drag-and-drop flows—lead capture se onboarding tak sab auto-pilot pe.' },
  { title: 'Unlimited Calendar Set up',   mrp: '3000', img: `src/assets/solution/time.png`,         tag: 'Manage',
    desc:'Book, reschedule, reminders—Google Calendar & Zoom integration.' },
  { title: 'Unlimited Contact Forms',     mrp: '3000', img: `src/assets/solution/contact-form.png`, tag: 'Build',
    desc:'Custom forms, validations & routing—no more generic Google Forms.' },
  { title: 'Unlimited Contacts Storing',  mrp: '2000', img: `src/assets/solution/book.png`,         tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Surveys',           mrp: '2000', img: `src/assets/solution/survey.png`,       tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited LMS',               mrp: '2000', img: `src/assets/solution/dashboard.png`,    tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Hosting Space',     mrp: '2000', img: `src/assets/solution/disk-usage.png`,   tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Payments (only 2% charges)', mrp: '2000', img: `src/assets/solution/payment-method.png`, tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Payments Pages',    mrp: '2000', img: `src/assets/solution/donation.png`,     tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Zoom Webinars / Meetings (500 People)', mrp: '2000', img: `src/assets/solution/zoom.png`, tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Staff Adding Facility', mrp: '2000', img: `src/assets/solution/add.png`,      tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Mobile / Web Push', mrp: '2000', img: `src/assets/solution/notification.png`, tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Live Supports',     mrp: '2000', img: `src/assets/solution/live-chat.png`,    tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
  { title: 'Unlimited Happiness!!!',      mrp: '2000', img: `src/assets/solution/happy.png`,        tag: 'Manage',
    desc:'Enriched profiles, segments & tags—perfect for targeted campaigns.' },
]
